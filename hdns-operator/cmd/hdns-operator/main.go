...
import (
	...
	"github.com/hamedetemaad/hdns-operator/internal/runner"
	"github.com/hamedetemaad/hdns-operator/pkg/controller"
...
func main() {
	...
	dbv1alpha1ClientSet, err := dbv1alpha1clientset.NewForConfig(restConfig)
	if err != nil {
		logger.Fatal("error creating hdns client ", err)
	}
